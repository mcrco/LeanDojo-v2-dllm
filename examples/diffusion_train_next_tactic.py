"""Train the diffusion denoising objective O1 on merged tactic data."""

from lean_dojo_v2.agent import BaseAgent
from lean_dojo_v2.trainer import DiffusionTrainer


class _DiffusionTrainingAgent(BaseAgent):
...
def main():
    ...
    trainer = DiffusionTrainer(
        ...
        output_dir="outputs-diffusion-next-tactic",
        objective="next_tactic",
        epochs_per_repo=1,
        batch_size=1,
        lr=2e-5,
    )

    agent = _DiffusionTrainingAgent(trainer=trainer)
